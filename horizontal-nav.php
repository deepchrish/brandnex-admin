    ...
    <div class="navbar-header">
      ...
      <div class="row">
        <div class="col-xs-5"><a class="nav-toggler visible-sm visible-xs toggle-left" href="#"
            onclick="toggleClass('.mobile-nav', 'visible')"><i class="ti-menu"></i></a></div>
        <div class="col-xs-2 col-md-12 p-0 px-lg-4">
          <a class="navbar-brand" href="index.php">
            <!-- Logo icon -->
            <b class="logo-icon">
              <!-- Dark Logo icon -->
              <img src="images/logo/side-logo-bg.png" alt="homepage" class="light-logo" />
            </b>
            <!--End Logo icon -->
            <!-- Logo text -->
            <span class="logo-text">
              <!-- dark Logo text -->
              <img src="images/logo/brandnex-logo-120x20.png" alt="homepage" class="light-logo" />
            </span>
            <!-- Logo icon -->
          </a>
        </div>
        ...
        <div class="col-xs-5 pull-right navs-right visible-sm visible-xs sw-xs-icons">
          <ul class="list-inline list-unstyled bn-head-nav">
            <li><a class="bn-bell" href="#" id="dropnotification" data-toggle="dropdown" aria-haspopup="true"
                aria-expanded="true"><img src="images/icons/ico-alarm.svg"><span class="bn-notification">05</span></a>
              <ul class="dropdown-menu" aria-labelledby="dropnotification">
            ...
            <li>
              <div class="dropdown">
                <button class="top-profile-btn dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown"
                  ...
                  <img src="images/logo/profile-pic.jpg">
