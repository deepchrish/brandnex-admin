                    ...
                    <div class="sw-form">
                        <form>
                            <div class="form-group">
                                <label class="control-label" for="inputFullName">What’s your full name?
                                    <span class="text-danger"> * </span>
                                </label>
                                <input type="text" class="form-control" id="inputFullName" placeholder="April Orenski">
                            </div>
                            <div class="form-group">
                                <div class="select-wrapper">
                                <label class="control-label" for="inputSelling">Are you already selling?
                                    <span class="text-danger"> * </span>
                                </label>
                                <select class="form-control" id="inputSelling" onchange="adSelectCheck(this);">
                                    <option data-index="1" value="nothing">Make your choice..</option>
                                    <option data-index="4" id="adSellingOnline" value="sellingonline">I’m selling, But
                                        not online</option>
                                    <option data-index="0" id="adDiffOption" value="selldifferentsystem">Yes, But with a
                                        different platform</option>
                                    <option data-index="5" id="adProductYet" value="sellproductyet">I’m not selling
                                        at all</option>
                                </select>
                                </div>
                            </div>
                            <div class="form-group" id="adSomethingSell" style="display:none;">
                                <div class="select-wrapper">
                                <label class="control-label" for="somethingSell">Have You ever designed your own
                                    products?
                                </label>
                                <select class="form-control" id="somethingSell">
                                    <option data-index="7" value="nothing">Make your choice..</option>
                                    <option data-index="8" value="swagify">No, This is my first time
                                    </option>
                                    <option data-index="9" value="brainstormingideas"> Yes, I have designed products
                                        before</option>
                                </select>
                                </div>
                            </div>
                            <div class="form-group" id="launchStore1" style="display:none;">
                                <div class="select-wrapper">
                                <label class="control-label" for="launchStore">Do you print your own products?
                                </label>
                                <select class="form-control" id="launchStore">
                                    <option data-index="10" value="nothing">Make your choice..</option>
                                    <option data-index="11" value="playingaround">I’d rather not answer
                                    </option>
                                    <option data-index="12" value="learning">Yes, I print and ship my own orders
                                    </option>
                                    <option data-index="13" value="fewweeks">Someone else print my orders for me
                                    </option>
                                </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group" id="adOptnCheck1" style="display:none;">
                                <div class="select-wrapper">
                                <label class="control-label" for="somethinglike">Which Platform do you sell the most on?
                                </label>
                                <select class="form-control" id="somethinglike">
                            ...
                            <div class="form-group">
                                <div class="select-wrapper">
                                <label class="control-label" for="inputEarning">How much are you earning?
                                    <span class="text-danger"> * </span>
                                </label>
                                <select class="form-control" id="inputEarning">
                            ...
                            <div class="form-group">
                                <div class="select-wrapper">
                                <label class="control-label" for="inputTimeZone">What’s your timezone
                                    <span class="text-danger"> * </span>
                                </label>
                            ...
                            <div class="my-3">
                                <div class="checkbox">
                                    <label for="check">
                                        <input type="checkbox" id="check"> Yes, I work for the company as a
                                        freelancer / employee
                                    </label>
                                </div>
                            </div>
