                        ...
                        <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10">
                            ...
                            <div class="sw-form">
                                <form>
                                    ...
                                    <div class="form-group has-success">
                                        <label class="control-label" for="inputPassword">Password (Min 8 characters)
                                    ...
                                    <div>
                                        <a href="index.php" class="btn btn-primary btn-block py-3">Sign me in</a> </div>
                                    <div class="text-center my-3"><a href="#">Umm.. I forgot my password</a></div>
                                    <div class="mt-5 text-center sw-acct-txt"> New to Swagify? Get Started
                                        <a href="signup.php"> Get Started </a> </div>
                                    <hr>
                                    <div class="mb-5 text-center px-4 text-muted">If you want to partner up or sell your designs as an
                                        artist with Swagify,
