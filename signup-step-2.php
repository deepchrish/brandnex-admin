        ...
        <div class="row sw-formarea">
            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 col-lg-offset-2 col-md-offset-2 col-sm-offset-2">
                <div class="my-5 py-sm-3 text-center">
                    <h1>Add a suitable address</h1>
                    <div>We will use your address to ship product samples or to get you paid.</div>
                </div>
                <div class="sw-form">
                    <form>
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group">
                                    <label class="control-label" for="inputFullName">Full Name
                                        <span class="text-danger"> * </span>
                                    </label>
                                    <input type="text" class="form-control" id="inputFullName"
                                        placeholder="April Orenski" name="fullname">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group">
                                    <label class="control-label" for="inputFullAddress">Full Address
                                        <span class="text-danger"> * </span>
                                    </label>
                                    <input type="text" class="form-control" id="inputFullAddress"
                                        placeholder="Alzoc III Icy Planet" name="fulladdress">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group">
                                    <div class="select-wrapper">
                                        <label class="control-label" for="inputCountry">Country/Region
                                            <span class="text-danger"> * </span>
                                        </label>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group">
                                    <div class="select-wrapper">
                                        <label class="control-label" for="inputState">State
                                            <span class="text-danger"> * </span>
                                        </label>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group">
                                    <div class="select-wrapper">
                                        <label class="control-label" for="inputCity">City
                                            <span class="text-danger"> * </span>
                                        </label>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group">
                                    <label class="control-label" for="inputZipcode">Zipcode
                                        <span class="text-danger"> * </span>
                                    </label>
                                    <input id="inputZipcode" type="number" class="form-control" name="zipcode"
                                        placeholder="9602">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group">
                                    <label class="control-label" for="inputNumber">Phone Number
                                        <span class="text-danger"> * </span>
                                    </label>
                                    <input id="inputNumber" type="tel" class="form-control" name="phonenumber"
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group">
                                    <label class="control-label" for="inputUrl">Personal Website or URL
                                    </label>
                                    <input id="inputUrl" type="url" class="form-control" name="websiteurl"
                                        placeholder="https://">
                                </div>
                            </div>
                        ...
                        <div class="text-center">
                            <a href="index.php" class="btn btn-primary px-5">Let's Finish</a>
                        </div>
                        <div class="text-center my-4">
                            <a href="signup-step-1.php">
                                <i class="mdi mdi-chevron-left sw-left-icn"></i>Go back
                            </a>
                        </div>
                    </form>
                </div>
